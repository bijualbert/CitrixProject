<#
.SYNOPSIS
  Remove a given number of Windows VDIDI
.DESCRIPTION
  Remove a given number of Windows VDI provided as a paramte
.EXAMPLE
    PS C:\PSScript > VDI_Removal.ps1 -VDICount 10 
    Remove 10 non persistent Windows VDI, split equally between the two DTC (GV1 and GV2)
.INPUTS
